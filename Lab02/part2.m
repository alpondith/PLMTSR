% 4-QAM: Quadrature Amplitude Modulation, a type of digital modulation where
% four different phases and amplitudes are used to represent 00, 01, 11, and 10 bits.
...
modulated_signal = pskmod(bit_stream,modulation_order);

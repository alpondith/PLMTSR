...
for i = 1: length(s) 
    ...
    legendInfo{i} = ['Simulated Rician PDF s = ' num2str(s(i))]; 
...
for i = 1:length(s) 
    ...
    legendInfo{i+length(s)} = ['Theoretical Rician PDF s = ' num2str(s(i))]; 
...
title('Rician PDF for various non centrality parameter and underlying sigma=1') 